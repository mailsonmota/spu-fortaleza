...
abstract class Alfresco_Rest_Abstract
{
    ...
    protected function _doPutRequest($url, $data)
    {
        $result = $this->_getCurlClient()->doPutRequest($url, $data);
    ...
    protected function _doAuthenticatedPutRequest($url, $data)
    {
        return $this->_doPutRequest($this->addAlfTicketUrl($url), $data);
    }
